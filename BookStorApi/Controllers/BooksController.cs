...
namespace BookStorApi.Controllers
{
    ...
    {
        private readonly BookStorApiContext _context;

        public BooksController(BookStorApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<BookModel>>> GetBookModel()
        {
          if (_context.BookModel == null)
          {
            ...
            return await _context.BookModel.Include(b => b.Authors).Include(b => b.Price).ToListAsync();
        }
        ...
        public async Task<ActionResult<BookModel>> PostBookModel(BookModel bookModel)
        {
          if (_context.BookModel == null)
          {
              return Problem("Entity set 'BookStorApiContext.BookModel'  is null.");
          }
